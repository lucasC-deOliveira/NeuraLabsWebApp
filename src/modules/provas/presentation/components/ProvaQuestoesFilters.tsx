...
function isDirty(criteria: ProvaQuestaoCriteria): boolean {
  return countActiveProvaQuestaoFilters(criteria) > 0 || criteria.search.trim() !== "";
}

export function ProvaQuestoesFilters({ criteria, tipos, tags, onPatch, onClear }: ProvaQuestoesFiltersProps) {
    ...
    <div className="space-y-2">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
        ...
        <Select
          ...
          onValueChange={(v) => onPatch({ sortBy: (v ?? "ordem") as ProvaQuestaoSort })}
        >
