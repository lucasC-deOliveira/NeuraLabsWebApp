...
const STRICT_DEBT = [
  ...
  "src/modules/graph/presentation/components/GraphLegend.tsx",
  ...
  "src/modules/graph/presentation/components/GraphToolbar.tsx",
  ...
  "src/modules/graph/presentation/services/edge-geometry.service.ts",
